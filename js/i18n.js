...
const translations = {
    en: {
        ...
        auth: {
            ...
            signInDesc: "Sign in to see your family savings",
            newHere: "New here?",
            joinFamily: "Join the Odelade Family"
        },
        register: {
    ...
    ig: {
        ...
        auth: { yourName: "Aha Gi", password: "Paswọọdụ", signIn: "Banye", createAccount: "Mepụta Akpa M", fullName: "Aha Gi Niile", fullNameHelper: "Tinye aha gi ka ezinụlọ mụrụ gi", createPassword: "Mepụta Paswọọdụ", createPasswordHelper: "Họrọ ihe i ga-echeta", confirmPassword: "Chọpụta Paswọọdụ", confirmPasswordHelper: "Pịnye paswọọdụ gi ọzọ", managerPassword: "Paswọọdụ Onye Nchịkwa", signInAsManager: "Banye Dịka Onye Nchịkwa", backToFamily: "Laghachi na nlogi ezinụlọ", alreadyHave: "I nwere akaụntụ?", noAccount: "Inweghi akaụntụ?", wrongCredentials: "Aha ma ọ bụ paswọọdụ ezighị ezi.", welcomeBack: "Nnoo", signInDesc: "Banye iji hụ nchekwa ezinụlọ gi", newHere: "Onye ọhụrụ?", joinFamily: "Sonye Ezinụlọ Odelade" },
    ...
    ar: {
        ...
        auth: {
            ...
            signInDesc: "سجل الدخول لمشاهدة مدخرات عائلتك",
            newHere: "جديد؟",
            joinFamily: "انضم إلى عائلة أوديلاد"
        },
        register: {
